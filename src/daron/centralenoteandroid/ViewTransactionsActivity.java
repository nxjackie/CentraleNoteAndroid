	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    BackToMain.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View v) {
	    		Intent i = new Intent(ViewTransactionsActivity.this, DebtsTableActivity.class);
	    		startActivity(i);
	        }
	      });
		...
		try {
			...
			List<Transaction> transactions = new GetTransactionTable().execute("http://centralenote.campus.ecp.fr/api/details.php").get();
